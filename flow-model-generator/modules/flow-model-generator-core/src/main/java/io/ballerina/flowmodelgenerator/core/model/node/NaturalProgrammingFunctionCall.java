...
/**
 * Represents a function call for natural programming.
 *
 * @since 2.0.0
 */
public class NaturalProgrammingFunctionCall extends FunctionCall {
    @Override
    public void setConcreteConstData() {
        codedata().node(NodeKind.NP_FUNCTION_CALL);
    }
